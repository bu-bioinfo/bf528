...
[Overlap ChIPseq peaks with RNAseq data]

[Replicate findings from original figures 2D and 2E]
...
Finally, with knowledge of the original publication, you will reproduce some of
the published figures and compare them to your own findings. 
...
- Recreate the figures from the original publication using your findings
...
work in tandem to regulate gene expression.
...
2. In the provided notebook, please make a table or take a screenshot of the top
...
Navigate to the associated publication for the dataset and find the link to
their GEO submission. Read the methods section of the paper and integrate your
called ChIPSeq peaks with the results from their differential expression RNAseq
experiment. Use your set of reproducible and filtered peaks, and use the
publication's listed significance thresholds for the RNAseq results.
...
In the original publication, the authors utilize the ChIPseq peaks and RNAseq
results and identified two prominent genes that appear in the results from both
analyses. 

:::{.box .task}

1. Use your set of reproducible peaks and a genome browser of your choice to 
recreate the visualizations seen in figures 2D and 2E. 
...
- Navigate to the publication's GEO accession and download their RNAseq differential
expression results

- Using your ChIPseq results and their RNAseq results, attempt to reproduce the
figures / results found in the publication (2D, 2E, 2F) using your findings