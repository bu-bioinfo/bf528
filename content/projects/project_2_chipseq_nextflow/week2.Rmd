...
from the IP samples and similar to each other. 
...
1. Create a module and use the multiBigwigsummary utility in deeptools to create a matrix containing
the information from the bigWig files of all of your samples.
...
is a commonly used tool that incorporates a Poisson model and other innovations to 
make robust peak-finding predictions. 
...
experiments have paired IP and controls.
...
Lab](https://github.com/Boyle-Lab/Blacklist)/ Please copy the provided file from
`references/` to your repository. 
...
2. Typically, any peaks that overlap a blacklisted region by even 1bp will be
removed. You may choose a different strategy if you prefer as long as you justify
your choice in the write-up later. 
...
their potential regulatory functions. 
