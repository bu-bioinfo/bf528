...
meant to assert that one approach or one set of results are the "ground truth".
...
3. In your provided notebook, please ensure you address the following questions:
