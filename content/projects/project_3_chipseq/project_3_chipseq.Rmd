...
3. The authors note that following Runx1 depletion, they do not observe widespread,
   major changes in TADs, but Runx1 is bound at TAD boundaries. What are some 
   additional experiments that could be performed to investigate the role of 
   Runx1 in genomic architecture?
  
4. Most of the discussion focused on the role of Runx1 at promoters, but it has
   been appreciated of late that binding in intergenic / intronic 
   regions can have functional, and regulatory effects. What are some experiments
   one could perform to investigate the potential effects of Runx1 binding to 
