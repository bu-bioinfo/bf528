...
## Choosing a filtering strategy for your raw counts
...
notebook, report the strategy you used and create a plot that demonstrates
the effects of your filtering on the counts for all of your samples.
...
formatted figures:
  ...
  2. The results from a DAVID or ENRICHR analysis on the significant genes at
  your chosen padj threshold.
...
matrix from our counts to assist us in our confidence in whether the differences we 
see in the differential expression analysis can likely be contributed to our biological
condition of interest.

:::{.box .task}

1. Choose an appropriate normalization strategy (rlog or vst) and generate a
normalized counts matrix for the experiment
...
4. In the provided notebook, comment in no less than two paragraphs about your
interpretations of these plots and if you believe the DE analysis was successful.
