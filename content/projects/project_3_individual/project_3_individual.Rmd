...
include the following:
  ...
  in your workflow. This should include specific software tools and their
  versions as well as any optional parameters that would affect the reproduction
  of your analysis

  2. A list of the questions you will address and the deliverables you will
  produce for each project. You may simply copy these from this proposal page.
...
project. You can look at this example to get a sense for what it should include:
...
your repo should contain the following at completion:
  ...
  packages each of your snakemake rules will utilize. 
    - You may simply copy the .yml specifications for different packages from 
  ...
  experiment: 
    - This will include any discussions requested in the project
      description 
    - This will include any figures / plots requested in the project
      description 
