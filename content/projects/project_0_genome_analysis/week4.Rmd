...
3. Read the [manual](https://www.ncbi.nlm.nih.gov/datasets/docs/v2/reference-docs/command-line/datasets/download/genome/) page for running the datasets command to figure out what file it outputs and what
each of the options specified in the observed command are doing.
