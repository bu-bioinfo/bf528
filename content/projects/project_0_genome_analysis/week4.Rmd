...
5. Complete the provided NCBI datasets module by using the correct command
for downloading files you observed before. You only need to download the genome
and do not need the other files. 
...
outputs of a specific process to another. 
