...
genome analysis. Kmers allow for fast and efficient analysis of genetic 
...
2. In your workflow `main.nf`, use the [channel factories](https://nextflow.io/docs/latest/reference/channel.html)
reference to create a channel that contains a range of numbers from 1 to 21. 
...
Use publishDir to copy these output files to your `results/` directory. 
