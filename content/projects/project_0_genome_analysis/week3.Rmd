...
script that will parse through the GFF, pick a single entry where the 6th field
is '+' (a sequence from the plus strand) and print out that entries accession,
start and stop coordinates to a text file in the format: genome:start-stop.
