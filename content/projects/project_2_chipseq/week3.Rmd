...
in the options for this tool (hg19). If you want to use the latest version (hg39),
you may need to have homer install it directly. There are some instructions here
on how to install hg39 (http://homer.ucsd.edu/homer/introduction/configure.html)
or if you try to use this option, run annotatePeaks.pl, and it returns an error, 
it will include the command to install genomes in the error message. 
