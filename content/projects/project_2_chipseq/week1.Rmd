...
these files to your `results/` directory in your working directory. I have also
provided you with a pre-built bowtie2 index for JUST chromosome 19 in this same
location. This index will allow you to quickly test your bowtie2 command. You
will eventually develop your own rule that creates a FULL genome index for
bowtie2 against the human reference genome.
