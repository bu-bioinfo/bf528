...
**Office hours:**
By appointment (jorofino@bu.edu) and weekly as determined in class
...
3. [Single Cell RNA-Seq Analysis of the Mouse Kidney][Project 3: Single Cell Analysis of the Mouse Kidney]

Project guidelines for the written reports (1, 2, 3) are here:
[Project Writeup Instructions]

## Grading and Assessment {-}

Grading and assessment will primarily be based on the final reports you write
at the completion of each project. You will be assessed based on completeness
(i.e. did you include all the deliverables requested?), and how well you communicate
your results in the style of a peer-reviewed publication. The weekly tasks will
represent a smaller portion of your grade and will largely be checked for 
completeness. You will be given feedback on your written reports and your final
grade will be determined by how well you incorporate that feedback into each
successive report. 
...
+----+-----+-----------+-----------------------------------------------+-----------------------------------+
| 2  | Mon | 1/22/2024 | [Genomics, Genes, and Genomes] & [git]        | Assignment 0 Assigned             |
+----+-----+-----------+-----------------------------------------------+-----------------------------------+
| 3  | Wed | 1/24/2024 | [Computational Pipeline Strategies] & [conda] |                                   |
+----+-----+-----------+-----------------------------------------------+-----------------------------------+
| 4  | Fri | 1/26/2024 | [Sequence Analysis Fundamentals]              |                                   |
+----+-----+-----------+-----------------------------------------------+-----------------------------------+
...
+----+-----+-----------+-----------------------------------------------+-----------------------------------+
| 9  | Wed | 2/7/2024  | [SCC Cluster Usage]                           |                                   |
+----+-----+-----------+-----------------------------------------------+-----------------------------------+
...
+----+-----+-----------+-----------------------------------------------+-----------------------------------+
| 21 | Fri | 3/8/2024  | [Genomic Variation and SNP Analysis]          |                                   |
+----+-----+-----------+-----------------------------------------------+-----------------------------------+
...
+----+-----+-----------+-----------------------------------------------+-----------------------------------+
| 25 | Mon | 3/18/2024 | [Microbiome: Metagenomics]                    | Wk2 - P2 Assigned / Wk2 - P1 Due  |
+----+-----+-----------+-----------------------------------------------+-----------------------------------+
| 26 | Wed | 3/20/2024 | Genome Browsers, Pt. 2                        |                                   |
+----+-----+-----------+-----------------------------------------------+-----------------------------------+
| 27 | Fri | 3/22/2024 | [Microbiome: 16s]                             |                                   |
+----+-----+-----------+-----------------------------------------------+-----------------------------------+
...
+----+-----+-----------+-----------------------------------------------+-----------------------------------+
| 34 | Mon | 4/8/2024  | [Single Cell Analysis Part 1]                 | Wk5 - P2 Assigned / Wk4 - P2 Due  |
+----+-----+-----------+-----------------------------------------------+-----------------------------------+
| 35 | Wed | 4/10/2024 | [Single Cell Analysis Part 2]                 |                                   |
+----+-----+-----------+-----------------------------------------------+-----------------------------------+
| 36 | Fri | 4/12/2024 | [Single Cell Analysis Part 3]                 |                                   |
+----+-----+-----------+-----------------------------------------------+-----------------------------------+
...
To be determined in class by vote based on your and my availability 
